...
k.setBotPredicate("name", "Salena")
k.setBotPredicate("email", "sarimzahid991@gmail.com")
k.setBotPredicate("botmaster", "Sarim Zahid")
k.setBotPredicate("master", "Sarim Zahid")
